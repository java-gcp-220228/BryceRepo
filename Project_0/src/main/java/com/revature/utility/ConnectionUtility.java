...
public class ConnectionUtility {
    ...
    public static Connection getConnection() throws SQLException {
        ...
        String url = "jdbc:postgresql://localhost:5432/postgres"; // System.getenv("db_url");
        String username = "postgres";// System.getenv("db_username");
        String password = "password"; // System.getenv("db_password");
